...
namespace AudioWorks.Common
{
    ...
    public sealed class AudioInvalidException : AudioException
    {
        ...
        public AudioInvalidException(string message)
            : base(message)
        {
        }
        ...
        public AudioInvalidException(string message, Exception innerException)
        ...
        AudioInvalidException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif
