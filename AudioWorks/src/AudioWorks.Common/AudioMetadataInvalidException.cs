...
namespace AudioWorks.Common
{
    ...
    public sealed class AudioMetadataInvalidException : AudioException
    {
        ...
        public AudioMetadataInvalidException([NotNull] string message)
            : base(message)
        {
        }
        ...
        public AudioMetadataInvalidException([NotNull] string message, [NotNull] Exception innerException)
