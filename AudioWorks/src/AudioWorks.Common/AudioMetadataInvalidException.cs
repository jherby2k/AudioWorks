...
namespace AudioWorks.Common
{
    ...
    public sealed class AudioMetadataInvalidException : AudioException
    {
        ...
        public AudioMetadataInvalidException(string message)
            : base(message)
        {
        }
        ...
        public AudioMetadataInvalidException(string message, Exception innerException)
        ...
        AudioMetadataInvalidException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif
