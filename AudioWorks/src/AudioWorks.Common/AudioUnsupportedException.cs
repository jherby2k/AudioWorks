...
namespace AudioWorks.Common
{
    ...
    public sealed class AudioUnsupportedException : AudioException
    {
        ...
        public AudioUnsupportedException(string message)
            : base(message)
        {
        }
        ...
        public AudioUnsupportedException(string message, Exception innerException)
        ...
        AudioUnsupportedException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
