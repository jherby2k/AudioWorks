...
#pragma warning restore CA2213 // Disposable fields should be disposed
        ...
        [UnmanagedCallersOnly]
        static EncoderSeekStatus SeekCallback(IntPtr handle, ulong absoluteOffset, IntPtr userData)
        {
            var stream = (Stream) GCHandle.FromIntPtr(userData).Target!;
        ...
        [UnmanagedCallersOnly]
        static unsafe EncoderTellStatus TellCallback(IntPtr handle, ulong* absoluteOffset, IntPtr userData)
        {
            var stream = (Stream) GCHandle.FromIntPtr(userData).Target!;
