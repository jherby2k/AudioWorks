...
namespace AudioWorks.Extensions.Flac
{
    static partial class LibFlac
    {
        ...
        internal static partial int StreamDecoderInitStream(
            ...
            LibFlac.StreamDecoderReadCallback readCallback,
            LibFlac.StreamDecoderSeekCallback? seekCallback,
            LibFlac.StreamDecoderTellCallback? tellCallback,
            LibFlac.StreamDecoderLengthCallback? lengthCallback,
            LibFlac.StreamDecoderEofCallback? eofCallback,
            LibFlac.StreamDecoderWriteCallback writeCallback,
            LibFlac.StreamDecoderMetadataCallback? metadataCallback,
            LibFlac.StreamDecoderErrorCallback errorCallback,
            IntPtr userData);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool StreamDecoderProcessUntilEndOfMetadata(
            StreamDecoderHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_decoder_process_single")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool StreamDecoderProcessSingle(
            StreamDecoderHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_decoder_get_state")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial DecoderState StreamDecoderGetState(
            StreamDecoderHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_decoder_finish")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool StreamDecoderFinish(
            StreamDecoderHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_decoder_delete")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial void StreamDecoderDelete(
            IntPtr handle);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial ulong StreamEncoderGetTotalSamplesEstimate(
            StreamEncoderHandle handle);
        ...
        internal static partial int StreamEncoderInitStream(
            StreamEncoderHandle handle,
            LibFlac.StreamEncoderWriteCallback writeCallback,
            LibFlac.StreamEncoderSeekCallback? seekCallback,
            LibFlac.StreamEncoderTellCallback? tellCallback,
            LibFlac.StreamEncoderMetadataCallback? metadataCallback,
            IntPtr userData);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_encoder_process")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool StreamEncoderProcess(
            StreamEncoderHandle handle,
            in IntPtr buffer,
            uint samples);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool StreamEncoderFinish(
            StreamEncoderHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_encoder_get_state")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial EncoderState StreamEncoderGetState(
            StreamEncoderHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__stream_encoder_delete")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial void StreamEncoderDelete(
            IntPtr handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__metadata_object_new")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial MetadataBlockHandle MetadataObjectNew(
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial void MetadataObjectDelete(
            IntPtr handle);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial void MetadataChainDelete(
            IntPtr handle);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static partial bool MetadataIteratorNext(
            MetadataIteratorHandle handle);

        [LibraryImport(_flacLibrary, EntryPoint = "FLAC__metadata_iterator_get_block")]
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial IntPtr MetadataIteratorGetBlock(
            MetadataIteratorHandle handle);
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.UserDirectories)]
        internal static partial void MetadataIteratorDelete(
            IntPtr handle);
