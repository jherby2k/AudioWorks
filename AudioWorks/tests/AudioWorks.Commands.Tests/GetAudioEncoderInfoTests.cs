...
{
    public sealed class GetAudioEncoderInfoTests(ModuleFixture moduleFixture) : IClassFixture<ModuleFixture>
    {
        ...
        public void ReturnsAudioEncoderInfo()
        {
            using (var ps = PowerShell.Create())
            {
                ...
                Assert.IsType<AudioEncoderInfo>(ps.Invoke()[0].BaseObject, false);
            }
        }
    }
}
