...
namespace AudioWorks.Extensibility.Tests
{
    public sealed class SampleBufferTests
    {
        ...
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new[] { 12, -25, 38, -51 }, 8, Label = "8-bit")]
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new[] { 3276, -6553, 9830, -13_107 }, 16, Label = "16-bit")]
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new[] { 838_860, -1_677_721, 2_516_582, -3_355_443 }, 24, Label = "24-bit")]
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new[] { 214_748_368, -429_496_736, 644_245_120, -858_993_472 }, 32, Label = "32-bit")]
        ...
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new byte[] { 141, 103, 167, 77 }, 8, Label = "8-bit")]
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new byte[] { 204, 12, 103, 230, 102, 38, 205, 204 }, 16, Label = "16-bit")]
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new byte[] { 204, 204, 12, 103, 102, 230, 102, 102, 38, 205, 204, 204 }, 24, Label = "24-bit")]
        [InlineData(new[] { 0.1f, -0.2f, 0.3f, -0.4f }, new byte[] { 208, 204, 204, 12, 96, 102, 102, 230, 128, 102, 102, 38, 192, 204, 204, 204 }, 32, Label = "32-bit")]
        ...
        [InlineData(1, -1, 0, Label = "1-bit")]
        [InlineData(2, -2, 1, Label = "2-bit")]
        [InlineData(3, -4, 3, Label = "3-bit")]
        [InlineData(4, -8, 7, Label = "4-bit")]
        [InlineData(5, -0x10, 0xF, Label = "5-bit")]
        [InlineData(6, -0x20, 0x1F, Label = "6-bit")]
        [InlineData(7, -0x40, 0x3F, Label = "7-bit")]
        [InlineData(8, -0x80, 0x7F, Label = "8-bit")]
        [InlineData(9, -0x100, 0xFF, Label = "9-bit")]
        [InlineData(10, -0x200, 0x1FF, Label = "10-bit")]
        [InlineData(11, -0x400, 0x3FF, Label = "11-bit")]
        [InlineData(12, -0x800, 0x7FF, Label = "12-bit")]
        [InlineData(13, -0x1000, 0xFFF, Label = "13-bit")]
        [InlineData(14, -0x2000, 0x1FFF, Label = "14-bit")]
        [InlineData(15, -0x4000, 0x3FFF, Label = "15-bit")]
        [InlineData(16, -0x8000, 0x7FFF, Label = "16-bit")]
        [InlineData(17, -0x1_0000, 0xFFFF, Label = "17-bit")]
        [InlineData(18, -0x2_0000, 0x1_FFFF, Label = "18-bit")]
        [InlineData(19, -0x4_0000, 0x3_FFFF, Label = "19-bit")]
        [InlineData(20, -0x8_0000, 0x7_FFFF, Label = "20-bit")]
        [InlineData(21, -0x10_0000, 0xF_FFFF, Label = "21-bit")]
        [InlineData(22, -0x20_0000, 0x1F_FFFF, Label = "22-bit")]
        [InlineData(23, -0x40_0000, 0x3F_FFFF, Label = "23-bit")]
        [InlineData(24, -0x80_0000, 0x7F_FFFF, Label = "24-bit")]
        [InlineData(25, -0x100_0000, 0xFF_FFFF, Label = "25-bit")]
        [InlineData(26, -0x200_0000, 0x1FF_FFFF, Label = "26-bit")]
        [InlineData(27, -0x400_0000, 0x3FF_FFFF, Label = "27-bit")]
        [InlineData(28, -0x800_0000, 0x7FF_FFFF, Label = "28-bit")]
        [InlineData(29, -0x1000_0000, 0xFFF_FFFF, Label = "29-bit")]
        [InlineData(30, -0x2000_0000, 0x1FFF_FFFF, Label = "30-bit")]
        [InlineData(31, -0x4000_0000, 0x3FFF_FFFF, Label = "31-bit")]
        [InlineData(32, -0x8000_0000, 0x7FFF_FFFF, Label = "32-bit")]
