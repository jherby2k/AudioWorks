    ...
    public static class EncodeValidFileDataSource
    {
        static readonly TheoryData<string, string, TestSettingDictionary, string[]> _data = new()
        {
            ...
            },
            {
                ...
                new[]
                {
                    "BD5F090F921BCC80F05FCBF5725D8E0E", // Opus 1.3.1 (Ubuntu 20.04)
            ...
            },
            {
                ...
                new[]
                {
                    "CD27FFC8398F52FB2F5984085D2215AC", // Opus 1.3.1 (Ubuntu 20.04 on Intel)
            ...
            },
            {
                ...
                new[]
                {
                    "9ED53495B32D47496C1C88B75D2FEF5F", // Opus 1.3.1 (Ubuntu 20.04 on Intel)
            ...
            },
            {
                ...
                new[]
                {
                    "1F81AFD1976BAB56F31A4599A8AD8FF1", // Opus 1.3.1 (Ubuntu 20.04)
            ...
            },
            {
                ...
                new[]
                {
                    "8FC7BCF02EDB42E9785797FD2C9A71D6", // Opus 1.3.1 (Ubuntu 20.04)
